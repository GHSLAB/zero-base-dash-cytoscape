...
styles = {
    ...
    "cytoscape": {"position": "absolute", "width": "100%", "height": "100%", "z-index": 999},
}
...
app.layout = html.Div(
    ...
    children=[
        html.Div(
            [html.Button("Responsive Toggle", id="toggle-button"), html.Div(id="toggle-text")]
        ),
        html.Div(
